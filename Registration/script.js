const scriptURL = "https://script.google.com/macros/s/AKfycbxS0PMEnWHVInHpHmBoBYbmHhCoIQ_LEOUCA-jACUBl3qQAAtJyEyJUekwaeB8VCdaTVA/exec";
...
function cleanPhoneCode(code) {
    return code.replace("+", "00").replace("-", "");
}
