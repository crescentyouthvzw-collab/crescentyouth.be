...
const translations = {
  nl: {
    ...
    donation_preview_label: 'Doneren',
    donation_preview_heading: 'Elke bijdrage telt',
    donation_preview_text: 'Kies een vast bedrag of doneer vrij. Elke bijdrage helpt onze jongerenwerking groeien.',
    ...
    donation_options_intro: 'Kies een bedrag dat bij jou past, of doneer vrij.',
  ...
  en: {
    ...
    donation_preview_label: 'Donate',
    donation_preview_heading: 'Every contribution matters',
    donation_preview_text: 'Choose a fixed amount or donate freely. Every contribution helps our youth work grow.',
    ...
    donation_options_intro: 'Choose an amount that suits you, or donate freely.',
  ...
  fr: {
    ...
    donation_preview_label: 'Faire un don',
    donation_preview_heading: 'Chaque contribution compte',
    donation_preview_text: 'Choisis un montant fixe ou fais un don libre. Chaque contribution aide notre travail jeunesse à grandir.',
    ...
    donation_options_intro: 'Choisis un montant qui te convient, ou fais un don libre.',
  ...
  ar: {
    ...
    donation_preview_label: 'تبرع',
    donation_preview_heading: 'كل مساهمة لها أثر',
    donation_preview_text: 'اختر مبلغًا محددًا أو تبرع بالمبلغ الذي تريده. كل مساهمة تساعد عملنا الشبابي على النمو.',
    ...
    donation_options_intro: 'اختر مبلغًا يناسبك، أو تبرع بالمبلغ الذي تريده.',
